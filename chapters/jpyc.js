...
function metamaskJpycSafety(){
 ...
 dialogue([
  ...
  [s.name,'「え、JPYCって表示されてても？」'],
  ['クロピー','「そうきゃわ。人気のあるトークンには、本物に見せかけた偽物が作られることがあるの。」'],
  ['ユリ','「第三者が同じ名前を使ったり、似たアイコンや同じアイコンを使って、正規のトークンのように見せるケースがあります。」'],
  [s.name,'「見た目だけじゃ、本物か偽物か分からないってことか。」'],
  ['クロピー','「そういうこときゃわ。だから“JPYCって書いてあるから本物”では判断しないの。」'],
  ['ユリ','「暗号資産では、トークン名やロゴだけではなく“どのネットワークの、どのコントラクトアドレスか”を確認することが大切です。」'],
...
function metamaskJpycNetwork(){
 ...
 dialogue([
  ...
  ['ユリ','「ちなみにJPYC EX公式ではEthereum・Avalanche C-Chain・Polygonに公式アドレスが案内されています。現在は同じ文字列のアドレスでも、ネットワークの確認は省略しないでください。」']
...
function metamaskJpycImport(){
 ...
 dialogue([
  ...
  ['ユリ','「トークンアドレスの欄に、JPYC EX公式で確認したコントラクトアドレスを貼り付けます。」'],
...
function metamaskJpycLessonYuri(){
 ...
 dialogue([
  ...
  [s.name,'「ネットワークをPolygonにして、JPYC EX公式でコントラクトアドレスを確認したから。」'],
